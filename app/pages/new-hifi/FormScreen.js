      ...
      <Layout style={{...styles.masterLayoutNoNav, alignItems: "flex-start"}}>
        <View style={{flex: 4, width: "100%", gap: 12}}>
          ...
          <View style={{width: "100%", gap: 8}}>
            ...
            <FormField navigation={navigation} destination={"Edit Duration"} label="Duration:" placeholder="Edit Duration" value={drug.duration && (drug.duration !==0 ?`${drug.duration} days`:"Just once")} drugObj={drug}/>
            <FormField navigation={navigation} destination={"Edit Frequency"} label="Frequency:" placeholder="Edit Frequency" value={drug.frequency && (drug.frequency !== 0?`Every ${drug.frequency} day(s)`:"Just once")} drugObj={drug}/>
